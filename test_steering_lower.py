#!/usr/bin/env python3
"""
Test steering with much lower strengths to maintain coherence.
"""
...
def main():
    ...
    # Test MUCH lower steering strengths to maintain coherence
    steering_strengths = [1.0, 2.0, 5.0, 10.0, 15.0, 20.0]
    
    for strength in steering_strengths:
        logger.info("\n" + "="*80)
        logger.info(f"Generating with steering strength {strength:.1f}...")
    ...
    # Save results
    output_path = "/workspace/diffing-toolkit/steering_test_11384_lower.json"
    ...
    print(f"Layer: {layer}")
    print(f"Tested strengths: {[0] + steering_strengths}")
