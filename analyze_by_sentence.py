#!/usr/bin/env python3
"""
Analyze KL divergence by sentence - top 3 tokens per sentence.
"""
...
def analyze_sentences():
    """Analyze KL divergence by sentence for all examples."""
    ...
    print("="*100)
    print("SENTENCE-LEVEL KL DIVERGENCE ANALYSIS")
